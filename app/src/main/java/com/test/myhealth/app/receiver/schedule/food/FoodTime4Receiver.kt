...
class FoodTime4Receiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        val builder = NotificationCompat.Builder(context!!, "foodTime4")
            .setSmallIcon(R.drawable.ic_app_fg)
            .setContentTitle("Напоминание: еда")
            .setContentText("Полдник")
            .setAutoCancel(true)
        ...
        notificationManagerCompat.notify(114, builder.build())
    }
}